<template>
  <div class="recoveryPage">
    <div class="tree-main">
      <ul class="tree-wrap">
        <tree-unit v-for="(model,i) in treeDataSource" :root="0" :num="i" :nodes="treeDataSource.length" @openExpand="openExpand" @delAction="delAction" :model.sync="model" :key="'root_'+i"></tree-unit>
      </ul>
    </div>
  </div>
</template>
